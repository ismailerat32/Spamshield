...
def settings():
    ...
    if request.method == "POST":
        try:
            ...
            settings["notify_spam"] = request.form.get("notify_spam") == "on"
            settings["notify_supheli"] = request.form.get("notify_supheli") == "on"
            settings["min_notify_score"] = int(request.form.get("min_notify_score", "35"))
